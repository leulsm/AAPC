        ...
        <div class="main-wrapper main-wrapper-1">
                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('admin.director') }}">Basic Form</a>
                                </li>
                                <li><a class="nav-link" href="{{ route('admin.userforms') }}">Advanced Form</a></li>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    <a href="https://www.aic.et/">Ethiopian Artificial Intelligence Institute, 2023</a></a>
                </div>
