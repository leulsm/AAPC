...
<head>
    ...
    <title>AAPC - Admin Dashboard Template</title>
                            ...
                            <div class="dropdown-list-content dropdown-list-icons">
                                <a href="#" class="dropdown-item dropdown-item-unread"> <span
                                        ...
                                        class="dropdown-item-icon bg-info text-white"> <i
                                            class="fas
												fa-bell"></i>
                                    </span> <span class="dropdown-item-desc"> Welcome to AAPC
                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        {{-- <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('admin.director') }}">Director</a></li>
                                        ...
                                        <div class="row ">
                                            {{-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                                <div class="card-content">
                                                    ...
                                                    <p class="mb-0"><span class="col-green">10%</span> Increase
                                                    </p>
                                                </div>
                                            </div> --}}
                    ...
                    <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                            <div class="card-content">
                                ...
                                <p class="mb-0"><span class="col-orange">09%</span> Decrease
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <div class="list-inline text-center">
                                        <div class="list-inline-item p-r-30"><i data-feather="arrow-down-circle"
                                            ...
                                            <p class="text-muted font-14 m-b-0">Monthly Earnings
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <div class="progress" data-height="6">
                                        <div class="progress-bar bg-success" data-width="50%">
                                        </div>
                                    </div>
                                </td>
                                <td>2018-01-20</td>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <div class="progress" data-height="6">
                                        <div class="progress-bar bg-danger" data-width="40%">
                                        </div>
                                    </div>
                                </td>
                                <td>2017-07-14</td>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <div class="progress" data-height="6">
                                        <div class="progress-bar bg-purple" data-width="55%">
                                        </div>
                                    </div>
                                </td>
                                <td>2019-07-25</td>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <div class="progress" data-height="6">
                                        <div class="progress-bar bg-orange" data-width="30%">
                                        </div>
                                    </div>
                                </td>
                                <td>2018-01-20</td>
                ...
                <div class="card-body">
                    ...
                    <div class="support-ticket media pb-1 mb-3">
                        ...
                        <div class="media-body ml-3">
                            ...
                            <p class="my-1">please check select item in advance form not work...
                            </p>
                    ...
                    <div class="support-ticket media pb-1 mb-3">
                        ...
                        <div class="media-body ml-3">
                            <div class="badge badge-pill badge-primary mb-1 float-right">Query
                            </div>
