...
<html lang="en" class="no-js">
    <!-- Mirrored from preview.themeforest.net/item/invera-investor-relations-corporate-information-wp-theme/full_screen_preview/42881253 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Jun 2023 09:08:45 GMT -->
    ...
    <head>
        ...
        <link
            rel="preload"
            href="home/public-assets.envato-static.com/assets/generated_sprites/logos-20f56d7ae7a08da2c6698db678490c591ce302aedb1fcd05d3ad1e1484d3caf9.png"
            as="image"
        />
        <link
            rel="preload"
            href="home/public-assets.envato-static.com/assets/generated_sprites/common-5af54247f3a645893af51456ee4c483f6530608e9c15ca4a8ac5a6e994d9a340.png"
            as="image"
        />

        <meta http-equiv="X-UA-Compatible" content="chrome=1" />
        <title>
            Invera - Investor Relations &amp; Corporate Information WP Theme
            Preview - ThemeForest
        </title>
        <meta
            name="description"
            content="&amp;lt;p&amp;gt;
Invera - the investor relations and corporate information WordPress theme is designed ..."
        />
        ...
        <link
            rel="stylesheet"
            media="all"
            href="https://public-assets.envato-static.com/assets/market/core/index-a23006723f9c650f843231dfe5ea70ba33fe1c0dac30968b043259a859edff53.css"
        />
        <link
            rel="stylesheet"
            media="all"
            href="https://public-assets.envato-static.com/assets/market/pages/preview/index-c20c294967c4ed0be90d33e130e591a57859fccaebd0a19bf00bf499d001afc3.css"
        />
        ...
        <script
            src="https://public-assets.envato-static.com/assets/market/pages/full_screen_preview/index-9382ca64d2c36a52f9d3bccb019934e2c36f37b33a1832e5fa300dbc5ace4452.js"
            nonce="6lyfeqQu2fVeK1ljHQuyRw=="
        ></script>

        <script nonce="6lyfeqQu2fVeK1ljHQuyRw==">
            //<![CDATA[
            //function to fix height of iframe!
            var calcHeight = function () {
                var headerDimensions = $(".preview__header").height();
                $(".full-screen-preview__frame").height(
                    $(window).height() - headerDimensions
                );
            };
    ...
    <body class="full-screen-preview">
        <div
            ...
            data-view="ctaHeader"
            data-item-id="42881253"
        >
            <div class="preview__envato-logo">
                <a
                    class="header-envato_market"
                    href="https://themeforest.net/item/invera-investor-relations-corporate-information-wp-theme/42881253"
                    >Envato Market</a
                >
            </div>
            ...
            <div id="js-preview__actions" class="preview__actions">
                <div class="preview__action--buy">
                    <a
                        class="header-buy-now e-btn--3d -color-primary"
                        href="https://themeforest.net/checkout/from_item/42881253?license=regular&amp;support=bundle_6month"
                        >Buy now</a
                    >
                </div>
            </div>
        ...
        <iframe
            ...
            src="http://themestate.com/demo/invera/"
            name="preview-frame"
            frameborder="0"
            noresize="noresize"
        ...
        <script
            ...
            data-cbid="4a6af4ea-f614-41d8-b0a9-8bb6d7fe4799"
            async="async"
            id="Cookiebot"
            nonce="6lyfeqQu2fVeK1ljHQuyRw=="
        ></script>
        ...
        <script
            src="https://public-assets.envato-static.com/assets/market/core/standardised_google_analytics_helpers-3bc54d0cbac28acaf9e49915490168f52bb9b8bea5d35f6edabb67a686a83af4.js"
            nonce="6lyfeqQu2fVeK1ljHQuyRw=="
        ></script>
        ...
        <script nonce="6lyfeqQu2fVeK1ljHQuyRw==">
            ...
            if (consentCookie) {
                var hasConsent =
                    Market.Helpers.CookieConsent.given("statistics");
            ...
            function consentToExperimentsEnrollmentGiven() {
                return (
                    Market.Helpers.CookieConsent.given("preferences") &&
                    Market.Helpers.CookieConsent.given("statistics")
                );
            }
                ...
                for (var i = 0; i < ACCOUNTS.length; i++) {
                    ...
                    if (
                        ...
                        cookieValue.replace(/\*/g, "!") ===
                            experimentEnrolmentsDataString
                    ) {
                ...
                domLoaded().then(() => {
                    ...
                    for (var i = 0; i < ACCOUNTS.length; i++) {
                        ...
                        ga(
                            t + ".require",
                            "linkid",
                            "http://preview.themeforest.net/item/invera-investor-relations-corporate-information-wp-theme/full_screen_preview/linkid.js"
                        );
                    }
            ...
            function decorateLink(event) {
                ...
                for (var i = 0; i < ACCOUNTS.length; i++) {
                    ...
                    if (link && link.href) {
                        if (
                            filteredDomains.includes(link.hostname) ||
                            currentSiteLinkOpensInNewWindow(link)
                        ) {
            ...
            function currentSiteLinkOpensInNewWindow(link) {
                return (
                    document.location.hostname === link.hostname &&
                    link.target === "_blank"
                );
            }
                ...
                (function () {
                    ...
                    if (Market.Helpers.GaLsUtils.localStorageAvailable()) {
                        if (Market.Helpers.GaLsUtils.clientIdNotPresent()) {
                            options.clientId =
                                Market.Helpers.GaLsUtils.retrieveClientId();
                        }

                        ga("create", accountId, options);
                        ga(function () {
                            var tracker = ga.getByName(options.name);
                            Market.Helpers.GaLsUtils.storeClientId(
                    ...
                    for (var i = 0; i < ACCOUNTS.length; i++) {
                        ...
                        if (
                            ...
                            consentToExperimentsEnrollmentGiven()
                        ) {
        ...
        */
                    ...
                    var e = {
                        _envArray: [],
                        _envTrkrs:
                            window._envTrkrsCust && window._envTrkrsCust.length
                                ? window._envTrkrs.concat(window._envTrkrsCust)
                                : window._envTrkrs,
                        init: function () {
                            for (var i = 0; i < _envTrkrs.length; i++) {
                                ...
                                if (!ga.getByName(name)) {
                                    ...
                                    if (
                                        Market.Helpers.GaLsUtils.localStorageAvailable()
                                    ) {
                                        if (
                                            Market.Helpers.GaLsUtils.clientIdNotPresent()
                                        ) {
                                            options.clientId =
                                                Market.Helpers.GaLsUtils.retrieveClientId();
                                        }
                        ...
                        wrapperInit: function () {
                            if (
                                typeof window._envIsRunning != "undefined" ||
                        ...
                        _envTrackevent: function (e, t, n, r) {
                            for (var i = 0; i < this._envTrkrs.length; i++) {
                                var s =
                                    this._envTrkrs[i][0].length == 0
                                        ? ""
                                        : this._envTrkrs[i][0] + ".";
                                r.length == 0
                                    ? ga(s + "send", "event", e, t, n)
                                    : ga(s + "send", "event", e, t, n, r);
                            }
                        },
                        ...
                        _envLinksTracker: function (t) {
                            ...
                            if (o.match(/^#/)) {
                                ...
                                u == undefined ||
                                u.length == 0 ||
                                f.match(/^javascript:/i)
                            ) {
                                return;
                            } else if (
                                new RegExp(c + "$", "i").test(u) ||
                                new RegExp(u + "$", "i").test(c)
                            ) {
                                if (
                                    i.download.run &&
                                    i.download.reg.length != 0
                                ) {
                                    if (
                                        new RegExp(i.download.reg, "i").test(
                                            a + l
                                        )
                                    ) {
                                        o = o.replace(/^https?:\/\//i, "");
        ...
        <script nonce="6lyfeqQu2fVeK1ljHQuyRw==">
            ...
            (function () {
                ...
                window.datadog_attributes["experiments"] =
                    experiment_data_string;
            })();
    ...
    <!-- Mirrored from preview.themeforest.net/item/invera-investor-relations-corporate-information-wp-theme/full_screen_preview/42881253 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Jun 2023 09:08:46 GMT -->
</html>
